        ...
        <Tooltip>
            <TooltipTrigger asChild>
                <Link
                    href={href}
                    className={cn([
                        'flex h-9 w-9 items-center justify-center rounded-lg hover:bg-stone-200 text-stone-400 hover:text-stone-800 transition-all md:h-8 md:w-8 duration-500',
                        { 'text-stone-800 bg-stone-200': now },
                    ])}>
