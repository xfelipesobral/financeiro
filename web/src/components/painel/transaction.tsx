...
const tabTriggerClassName =
    'py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow'
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-150 w-full">
                <DialogHeader>
                    ...
                    <DialogDescription className="max-w-100">
                ...
                <div className="grid gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <Controller
                            ...
                            control={control}
                            render={({ field: { name, value, onChange } }) => (
                                <Combobox id={name} list={categories} selected={value} onChange={onChange} title="Categoria" />
                            )}
                        />
                    </div>
                    ...
                    <div className="flex gap-4">
                        <div className="w-full flex flex-col gap-4">
                            <Controller
                                ...
                                control={control}
                                render={({ field: { name, value, onChange } }) => (
                                    <SelectDate id={name} title="Data" selected={value} onChange={onChange} />
                                )}
                            />

                            <div>
                                <Label htmlFor="descricao">Descrição</Label>
                                <Input id="descricao" placeholder="Descrição da movimentação" {...register('description')} />
                            </div>
                        </div>
                        <div className="w-full flex flex-col bg-muted rounded-lg">
                            <div className="p-4 flex items-center justify-center flex-col flex-1 gap-2">
                                <div className="w-full flex flex-col items-center justify-center px-4">
                                    <PiggyBank className="h-10 w-10 text-stone-800" />
